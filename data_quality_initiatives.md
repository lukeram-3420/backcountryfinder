...
**Status (2026-04-17):** Initiatives 1–7 shipped. Initiative 1 scraper-side in `5157faa`, admin fast-follow in `c83bd4a`. Initiative 2 in `5abb3f1`. Initiative 3 plan in `cd13bcc`, implementation in `615c5e9`. Initiative 5 plan in `8885144`, implementation in `300eae3`. Initiative 4 plan in `1b5604c` (corrected scope replacing rejected `39eb59b` two-condition version), implementation in `cdb0581`. Initiatives 6 + 7 plan in `767ab9b`, implementation in this commit.
